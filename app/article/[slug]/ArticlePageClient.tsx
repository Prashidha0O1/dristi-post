    ...
    <PageShell>
      <SimpleGrid columns={{ base: 1, lg: 3 }} gap="36px">
        <Box gridColumn={{ lg: "span 2" }}>
          ...
          <Box position="relative" w="full" style={{ aspectRatio: 16/9 }} borderRadius="4px" overflow="hidden" mb="28px">
          ...
          <Box
            ...
            css={{
              ...
              "& ul": { paddingLeft: "26px", marginBottom: "20px", listStyleType: "disc" },
              "& ol": { paddingLeft: "26px", marginBottom: "20px", listStyleType: "decimal" },
